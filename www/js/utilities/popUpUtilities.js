...
(function() {
	this.app.service('popUpService', ['$q', '$ionicPopup',
		function($q, $ionicPopup) {
			...
			return{
				...
				showPopUpFailCreateFactor : function(_translation){
					...
					let button_exit_lesson = [{ text: _translation.MODAL_FAIL_CREATE_FACTOR_BUTTON,  type: 'button-afirmative',onTap: function() {
						return true;
					}}];
				...
				showpopUpProfileFail : function(_translation){
					let deferred = $q.defer();
					let button_exit_lesson = [{ text: _translation.MODAL_FAIL_CREATE_FACTOR_BUTTON,  type: 'button-special',onTap: function() {
						return true;
					}}];
				...
				showpopupCountries : function(_translation){
					let deferred = $q.defer();
					let button_exit_lesson = [{ text: 'Re-intentar / Try again',  type: 'button-afirmative',onTap: function() {
						return true;
					}}];
				...
				showpopupLinkedInRegister : function(_translation){
					let deferred = $q.defer();
					let button_exit_lesson = [{ text: 'Entendido',  type: 'button-afirmative',onTap: function() {
						return true;
					}}];
